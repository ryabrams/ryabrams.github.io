...
For email, the fix is easy: always UTM-tag every link in every email, then use a redirect service that preserves parameters. For dark social and PDFs, you can't fully solve it, but you can track i[...]
...
That last question is the health check. If direct traffic spikes suddenly, something broke — and it's usually a missing UTM somewhere in a new campaign or a tool integration that isn't preservin[...]
